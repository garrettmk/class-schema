...
export function applyPropertyActions<Metadata, Context = unknown>(metadata: Metadata, propertyKey: PropertyKey, context: Context, actions: MaybeArray<PropertyAction<Metadata, Context>>): Metadata {
