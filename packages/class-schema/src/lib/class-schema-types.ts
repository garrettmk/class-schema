...
export type PropertyMetadata<T = unknown> = T extends
  | BooleanConstructor
  | BooleanConstructor[]
...
export const ClassMetadataManager = MetadataManagerClass<
  ClassMetadata,
  Constructor
>();
...
export const PropertiesMetadataManager = MetadataManagerClass<
  PropertiesMetadata,
  object
>();

export type ClassPropertyAction = MetadataAction<
  PropertyMetadata,
  PropertyContext
>;
