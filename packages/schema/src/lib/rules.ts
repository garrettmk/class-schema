...
import { BooleanFieldMetadata, FieldMetadata, GenericFieldMetadata, TargetContext } from "./class-schema-types";
import { decorateProperty, decoratePropertyWith, setPropertyFaker } from "./property-actions";
import { innerTypeExtends, innerTypeMatches, isArrayField, isConstructorField, isFakerUnset, propertyMetadataMatches } from "./property-selectors";
import { getTypeInfo } from "./util/get-type-info";
import { getInnerType } from "./util/inner-type";

export const optional = true;

export const commonRules = new PropertyRuleSet<GenericFieldMetadata, TargetContext>([
    {
...
export const booleanRules = new PropertyRuleSet<BooleanFieldMetadata, TargetContext>([
    {
