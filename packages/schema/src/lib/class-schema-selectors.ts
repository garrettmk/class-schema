...
export function isOptionalField(metadata: PropertyMetadata): metadata is PropertyMetadata & { optional: true } {
    return Boolean(metadata.optional);
}

export function isArrayField(metadata: PropertyMetadata): metadata is PropertyMetadata<unknown[]> {
    return getTypeInfo(metadata.type).isArray;
}

export function isConstructorField(metadata: PropertyMetadata): metadata is PropertyMetadata<Constructor> {
...
export function innerTypeMatches<Type extends Constructor>(...types: Type[]): MetadataTypeGuard<PropertyMetadata, PropertyMetadata<Type> | PropertyMetadata<Type[]>> {
...
export function innerTypeExtends<Type extends Constructor>(type: Type): MetadataTypeGuard<PropertyMetadata, PropertyMetadata<Type> | PropertyMetadata<Type[]>> {
    return function (metadata): metadata is (PropertyMetadata<Type> | PropertyMetadata<Type[]>) {
